...
import static com.jordansimsmith.japanesedictionary.AuthHandler.AuthorizerEvent;
import static com.jordansimsmith.japanesedictionary.AuthHandler.AuthorizerResponse;
...
public class AuthHandler implements RequestHandler<AuthorizerEvent, AuthorizerResponse> {
  ...
  @VisibleForTesting static final String SECRET = "japanese_dictionary_api";
