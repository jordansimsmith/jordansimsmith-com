...
public class DeleteBookHandler
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(DeleteBookHandler.class);
  ...
  @VisibleForTesting
  DeleteBookHandler(BookTrackerFactory factory) {
  ...
  public APIGatewayV2HTTPResponse handleRequest(APIGatewayV2HTTPEvent event, Context context) {
    try {
      ...
      LOGGER.error("error processing delete book request", e);
  ...
  private APIGatewayV2HTTPResponse doHandleRequest(APIGatewayV2HTTPEvent event) {
    ...
    bookTrackerTable.deleteItem(key);
