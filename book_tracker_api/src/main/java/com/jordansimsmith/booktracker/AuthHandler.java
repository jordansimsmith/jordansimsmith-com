...
import static com.jordansimsmith.booktracker.AuthHandler.AuthorizerEvent;
import static com.jordansimsmith.booktracker.AuthHandler.AuthorizerResponse;
...
public class AuthHandler implements RequestHandler<AuthorizerEvent, AuthorizerResponse> {
  ...
  @VisibleForTesting static final String SECRET = "book_tracker_api";
  ...
  @VisibleForTesting
  AuthHandler(BookTrackerFactory factory) {
