  ...
  private static BaseTemplate createBaseTemplate() {
    var items =
        List.of(
            ...
            new TemplateItem("toe spacers", "toiletries", 1, List.of()),
            new TemplateItem("razor", "toiletries", 1, List.of()),
            new TemplateItem("nail clippers", "toiletries", 1, List.of("optional")),
