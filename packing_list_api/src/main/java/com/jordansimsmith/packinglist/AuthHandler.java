...
import static com.jordansimsmith.packinglist.AuthHandler.AuthorizerEvent;
import static com.jordansimsmith.packinglist.AuthHandler.AuthorizerResponse;
...
public class AuthHandler implements RequestHandler<AuthorizerEvent, AuthorizerResponse> {
  ...
  @VisibleForTesting static final String SECRET = "packing_list_api";
  ...
  @VisibleForTesting
  AuthHandler(PackingListFactory factory) {
