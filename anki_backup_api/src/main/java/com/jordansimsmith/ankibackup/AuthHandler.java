...
import static com.jordansimsmith.ankibackup.AuthHandler.AuthorizerEvent;
import static com.jordansimsmith.ankibackup.AuthHandler.AuthorizerResponse;
...
public class AuthHandler implements RequestHandler<AuthorizerEvent, AuthorizerResponse> {
  ...
  @VisibleForTesting static final String SECRET = "anki_backup_api";
  ...
  @VisibleForTesting
  AuthHandler(AnkiBackupFactory factory) {
