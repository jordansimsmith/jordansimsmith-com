...
public class DeleteScanRowHandler
  ...
  private APIGatewayV2HTTPResponse doHandleRequest(APIGatewayV2HTTPEvent event) {
    ...
    var rowItem = scanRepository.getScanRow(user, scanId, scanPosition);
    if (rowItem == null) {
      return httpResponseFactory.notFound(new ErrorResponse("Not Found"));
    }

    if (!scanRepository.deleteScanRow(user, scanId, scanPosition)) {
      ...
      var currentRow = scanRepository.getScanRow(user, scanId, scanPosition);
      if (currentRow == null) {
        return httpResponseFactory.notFound(new ErrorResponse("Not Found"));
      }
