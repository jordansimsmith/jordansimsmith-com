...
Judge each criterion independently. A listing that clearly fails one criterion still gets an honest judgment on the other three. If the items are not Magic: The Gathering cards at all, judge the remaining three criteria as pass (they are treated as inapplicable).
...
Respond with a JSON object with exactly these four keys: "mtg_cards", "bulk_scale", "not_basic_lands", "fixed_collection". Each value is an object with:
...
Expected judgment: {"mtg_cards": "pass", "bulk_scale": "fail", "not_basic_lands": "fail", "fixed_collection": "fail"}
...
Expected judgment: {"mtg_cards": "pass", "bulk_scale": "pass", "not_basic_lands": "pass", "fixed_collection": "pass"}
Note: great listing
...
Expected judgment: {"mtg_cards": "pass", "bulk_scale": "fail", "not_basic_lands": "pass", "fixed_collection": "pass"}
...
Expected judgment: {"mtg_cards": "pass", "bulk_scale": "pass", "not_basic_lands": "fail", "fixed_collection": "pass"}
Note: basic lands
...
Expected judgment: {"mtg_cards": "fail", "bulk_scale": "pass", "not_basic_lands": "pass", "fixed_collection": "pass"}
...
Expected judgment: {"mtg_cards": "pass", "bulk_scale": "pass", "not_basic_lands": "pass", "fixed_collection": "fail"}
Note: synthetic: multiple lots - fixed_collection fails
