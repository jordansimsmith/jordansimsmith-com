...
Judge each criterion independently. A listing that clearly fails one criterion still gets an honest judgment on the other four. If the items are not Magic: The Gathering cards at all, judge the remaining four criteria as pass (they are treated as inapplicable).
...
A lot's set origin or crossover branding is never a reason to fail. Treat Universes Within and Universes Beyond cards identically.
...
Respond with a JSON object with exactly these five keys: "mtg_cards", "bulk_scale", "not_basic_lands", "civilian_seller", "fixed_collection". Each value is an object with:
...
Expected judgment: {"mtg_cards": "pass", "bulk_scale": "fail", "not_basic_lands": "fail", "civilian_seller": "pass", "fixed_collection": "fail"}
...
Expected judgment: {"mtg_cards": "pass", "bulk_scale": "pass", "not_basic_lands": "pass", "civilian_seller": "pass", "fixed_collection": "pass"}
Note: great listing
...
Expected judgment: {"mtg_cards": "pass", "bulk_scale": "fail", "not_basic_lands": "pass", "civilian_seller": "pass", "fixed_collection": "pass"}
...
Expected judgment: {"mtg_cards": "pass", "bulk_scale": "pass", "not_basic_lands": "fail", "civilian_seller": "pass", "fixed_collection": "pass"}
Note: basic lands
...
Expected judgment: {"mtg_cards": "pass", "bulk_scale": "pass", "not_basic_lands": "pass", "civilian_seller": "pass", "fixed_collection": "pass"}
Note: synthetic: primarily Universes Beyond mixed lot remains eligible
...
Expected judgment: {"mtg_cards": "fail", "bulk_scale": "pass", "not_basic_lands": "pass", "civilian_seller": "pass", "fixed_collection": "pass"}
...
Expected judgment: {"mtg_cards": "pass", "bulk_scale": "pass", "not_basic_lands": "pass", "civilian_seller": "fail", "fixed_collection": "fail"}
